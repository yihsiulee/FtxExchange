...
import { getBalance, getPosition, getAllImplicitApiMethods, getAccount,getMarkets,getOrderHistory } from '../api'
            ...
            <Table className={classes.root} aria-label="simple table">
                ...
                <TableBody>
                    ...
                    <TableRow >
                        ...
                        <StyledTableCell align="right">{_.get(account, 'result.totalAccountValue', 0)}{console.log(account)}</StyledTableCell>
